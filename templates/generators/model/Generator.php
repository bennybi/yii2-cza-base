...
namespace cza\base\templates\generators\model;
...
class Generator extends \yii\gii\Generator {
    ...
    public $withTranslation = true;

    /**
     * @inheritdoc
     */
    public function getName() {
        return 'Cza Model Generator';
    }
    ...
    public function hints() {
        return array_merge(parent::hints(), [
            ...
            'withTranslation' => 'This indicates whether cza-translations feature.',
        ]);
    }
    ...
    public function generateRules($table) {
        ...
        if(!empty($types['required'])){
            $rules[] = "[['" . implode("', '", $types['required']) . "'], 'required', 'on' => OperationScenario::CREATE]";
            $rules[] = "[['" . implode("', '", $types['required']) . "'], 'required', 'on' => OperationScenario::UPDATE]";
        }
