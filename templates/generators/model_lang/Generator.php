...
namespace cza\base\templates\generators\model_lang;
...
class Generator extends \yii\gii\Generator {
    ...
    public function getName() {
        return 'Cza Language Model Generator';
    }
    ...
    public function rules() {
        return array_merge(parent::rules(), [
            [['db', 'ns', 'tableName', 'modelClass', 'sourceModelClass', 'baseClass'], 'filter', 'filter' => 'trim'],
            [['ns'], 'filter', 'filter' => function($value) {
            return trim($value, '\\');
        }],
            [['db', 'ns', 'tableName', 'sourceModelClass', 'baseClass'], 'required'],
            [['db', 'modelClass', 'sourceModelClass'], 'match', 'pattern' => '/^\w+$/', 'message' => 'Only word characters are allowed.'],
    ...
    public function attributeLabels() {
        return array_merge(parent::attributeLabels(), [
            ...
            'sourceModelClass' => 'Source Model Class',
    ...
    public function hints() {
        return array_merge(parent::hints(), [
            ...
            'sourceModelClass' => 'This is the class name of the source entity model',
    ...
    public function generateTransClassName($className) {
