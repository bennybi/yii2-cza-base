...
/**
 * support db entity i18n manipulation, refer to https://github.com/2amigos/yii2-translateable-behavior, i modified/added some new features
 * 
 * @author Ben Bi <ben@cciza.com>
 * @link http://www.cciza.com/
 * @copyright 2014-2016 CCIZA Software LLC
...
//        Yii::info('init');
//        if ($this->owner)
//            Yii::info($this->owner->className() . ":" . $this->owner->id);
//    }
...
//        $result = $model->save();
//        if (!$result) {
//            Yii::info(\yii\helpers\VarDumper::dumpAsString($model->getErrors()));
//        }
//        return $result;
        return $model->save();
    }
